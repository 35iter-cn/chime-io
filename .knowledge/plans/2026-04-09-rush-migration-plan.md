...
- Create: `.knowledge/docs/rush/README-RUSH.md` (帮助文档，可选但推荐)
...
**Files:**
- Create: `.knowledge/docs/rush/README-RUSH.md`
- Modify: `README_RELEASE.md`（加入 Rush 发布流程示例）

- [ ] **Step 1: 写入最小上手文档 `.knowledge/docs/rush/README-RUSH.md`**
...
Plan saved to `.knowledge/plans/2026-04-09-rush-migration-plan.md`.
